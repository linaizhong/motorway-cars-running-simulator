  ...
  public SoundManager() {
    try {
      AudioInputStream inputStream = AudioSystem.getAudioInputStream(new File(
          "resources\\audios\\Traffic Sounds - Free Sound Effects - Traffic Sound Clips - Sound Bites.wav"));
      AudioInputStream driftStream = AudioSystem.getAudioInputStream(new File("resources\\audios\\drift.wav"));
